...
In addition, this reposiroty contains the scripts used to perform another case study in which the sugar extractives (or hydrophilic extractives) and pulp are further processed into functional films replacing on packaging materials (e.g., kraft liner, PET, LDPE) on existing market. This case study is based on the same life cycle inventory as the publication above and adds a processing step to produce lignin containing microfibrillated cellulose coated with extractives. More information on the system studied are included in the main article and associated supplementary documents: 
